...
from tvm import relax, te, tir, topi, IRModule
...
def create_shard_info_func(param_manager, args, model_config) -> IRModule:
...
def create_shard_transformation_func(param_manager, args, model_config) -> IRModule:
    ...
    with bb.function("transform_params"):
        ...
        for i_qparam, qparam_sinfo in enumerate(q_params):
            ...
            if isinstance(param.quant_spec, quantization.NoQuantizationSpec):
                arg_name = param.name
